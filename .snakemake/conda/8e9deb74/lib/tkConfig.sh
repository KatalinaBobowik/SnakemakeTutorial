...
# installed.
TK_PREFIX='/home/kbobowik/snakemake-tutorial/.snakemake/conda/8e9deb74'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/kbobowik/snakemake-tutorial/.snakemake/conda/8e9deb74'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/kbobowik/snakemake-tutorial/.snakemake/conda/8e9deb74/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/kbobowik/snakemake-tutorial/.snakemake/conda/8e9deb74/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/kbobowik/snakemake-tutorial/.snakemake/conda/8e9deb74/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/home/kbobowik/snakemake-tutorial/.snakemake/conda/8e9deb74/lib/libtkstub8.6.a'
